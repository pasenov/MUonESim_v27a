...
class EventAction : public G4UserEventAction
{
  ...
  public:
    ...
    void AddPointEntranceT(G4ThreeVector vec)  {fPointEntranceT += vec;};
    void AddPointExitT(G4ThreeVector vec)  {fPointExitT += vec;};
  ...
  private:
    ...
    G4ThreeVector fPointEntranceT, fPointExitT;
