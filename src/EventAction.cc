...
fAnglee = 0.;
 ...
 fPointEntranceT = fPointExitT = G4ThreeVector(0, 0, 0);
...
void EventAction::EndOfEventAction(const G4Event* evt)
{
 ...
 if ((fBoolPrim == 1) && (fBoolePP1Cut1GeV == 1))  {
    ...
    analysisManager->FillH2(13, fEnergyExitTargetPP1Cut1GeV, fAnglePP1Cut1GeV);
 }
 if ((fBoolPrim == 1) && (fBoolePP2Cut1GeV == 1))  {
    analysisManager->FillH2(10, fAnglePP2Cut1GeV, fAnglePrimary);
    analysisManager->FillH2(13, fEnergyExitTargetPP2Cut1GeV, fAnglePP2Cut1GeV);
 }
 ...
 if ((fBoolPrim == 1) && (fBoolePP1Cut1GeV == 1) && (fBoolePP2Cut1GeV == 1))  {
    analysisManager->FillH2(12, fAnglePP2Cut1GeV, fAnglePP1Cut1GeV);
 } 
 
 analysisManager->FillH2(14, fPointEntranceT.x(), fPointEntranceT.y());
 analysisManager->FillH2(15, fPointExitT.x(), fPointExitT.y());
